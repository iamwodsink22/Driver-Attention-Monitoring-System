...
def draw_pose_info(frame, img_point, point_proj, roll=None, pitch=None, yaw=None):
    ...
    if roll is not None and pitch is not None and yaw is not None:
        cv2.putText(frame, "Roll:" + str(round(roll, 3)), (900, 400),
                    cv2.FONT_HERSHEY_PLAIN, 10, (255, 255, 255), 3, cv2.LINE_AA)
        cv2.putText(frame, "Pitch:" + str(round(pitch, 3)), (900, 500),
                    cv2.FONT_HERSHEY_PLAIN, 10, (255, 255, 255), 3, cv2.LINE_AA)
        cv2.putText(frame, "Yaw:" + str(round(yaw, 3)), (900, 600),
                    cv2.FONT_HERSHEY_PLAIN, 10, (255, 255, 255), 3, cv2.LINE_AA)
